...
<!--导航条-->
<div class="width100" style="height: 45px;background: #DB7093;margin-top: 15px;position: relative;z-index: 100;">
    <!--中间的部分-->
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        <!--列表导航-->
        <div class="left_yh Selected" style="width: 230px;height: 45px;background:#DB7093" id="hiddenShow">
            <!--头部的图标-->
            ...
            <!--导航展开部分-->
            <div class="downSlide" style="background: #DB7093">
                <c:forEach items="${lbs}" var="data" varStatus="l">
                    <div class="n1Nav">
                        ...
                        <div class="n2Nav">
                            <div class="n3Nav">
                                <h3 style="color:#DB7093;">${data.father.name}</h3>
        ...
        <div class="left_yh font16" id="pageNav">
            <a href="${ctx}/login/uIndex">小铺首页</a>
            <a href="${ctx}/news/list">活动公告</a>
            <a href="${ctx}/message/add">买家留言</a>
        </div>
    </div>
</div>
<!--轮动广告-->
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div class="example2" style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <ul>
            <li><img src="${ctx}/resource/images/lunbo2.png" alt=""></li>
            <li><img src="${ctx}/resource/images/lunbo3.png" alt=""></li>
...
<div class="width1200 center_yh hidden_yh">
    <div class="width100" style="height: 45px;line-height: 45px;border-bottom: 2px solid  #DB7093; margin-top: 20px;">
        <font class="left_yh font20"color="#DB7093">折扣花束</font>
    </div>
...
<div class="width1200 center_yh hidden_yh">
    <div class="width100" style="height: 45px;line-height: 45px;border-bottom: 2px solid #DB7093; margin-top: 20px;">
        <font class="left_yh font20"color="#DB7093">热销花束</font>
    </div>
    <div class="width100 hidden_yh" style="height: 480px;">
        <div class="normalPic">
