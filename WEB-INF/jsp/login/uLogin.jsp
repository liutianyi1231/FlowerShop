    ...
    <div class="width1200 hidden_yh center_yh" style="margin-top: 75px">
        <div class="right_yh bj_fff" style="width:408px;height: 438px;">
            <form action="${ctx}/login/utoLogin" method="post">
                <h3 class="tcenter font30 c_33" style="font-weight: 100;margin-top: 36px;margin-bottom: 36px; color: #58101E"><strong>用户登录</strong></h3>
...
<%--                        <img src="${ctx}/resource/user/images/pass.jpg" alt="" class="left_yh" width="42" height="42">--%>
                    ...
                    <div>
                    <input type="submit" value="登录" class="center_yh" style="width: 100%;height: 43px;font-size: 16px;background: #E98582;outline: none;border: 0;color: #fff; cursor:pointer;">
                    </div>
                    <div class="center_yh"  style="width: 100%;height: 10px;font-size: 16px;background: #FFFFFF;outline: none;border: 0;color: #fff; cursor:pointer;"></div>
                        <div class="center_yh"  style="text-align: center;width: 100%;height: 43px;font-size: 16px;background: #e4b9c0;outline: none;border: 0;color: #fff; cursor:pointer;" >
                    <a  href="${ctx}/login/res"  style="display:block; height: 43px;line-height: 43px;">注册</a>
                    </div>
                </div>
            </form>
        </div>
